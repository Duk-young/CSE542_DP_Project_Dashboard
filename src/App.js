...
const App = () => {
  ...
  return (
    ...
    <div>
      ...
      <StreamControl setPostsData={setPostsData} setCommentsData={setCommentsData} setPostsDPData={setPostsDPData} setCommentsDPData={setCommentsDPData} positiveCount={positiveCount} negativeCount={negativeCount}/>
